...
IMAGE_PATH='/data/berisha_lab/neuwirth/data/ov-63-hd-16ca-c-mnf16-bc-n'

TRAIN_MASK_PATH='/data/berisha_lab/neuwirth/annotations_3/train/'
TEST_MASK_PATH='/data/berisha_lab/neuwirth/annotations_3/test/'


names = ["Random Forest", "RBF SVM", "Linear SVM", "Neural Net", "AdaBoost",
