...
# ndeeded to avoid image size complaint
import PIL.Image
...
class hsi_cnn_reader_keras(object):
    '''
    ...
    def _load_mask_files(self):
        ...
        for i in range(self.__num_masks):
            ...
            if overlap is None: overlap = np.copy(temp)
            else: overlap += temp
            bad_idx = overlap > 1
            temp[bad_idx] = 0
    ...
    def _next_record(self):
        ...
        '''
        if utils_keras.is_empty(self.__cur_data) or \
